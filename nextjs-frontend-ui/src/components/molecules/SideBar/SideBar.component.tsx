...
const SideBar = ({ title, disabled, disableCommunities }: IAuthPageWrapper) => {
    ...
    useEffect(() => {
        ...
        const storedChallengeSelection = localStorage.getItem('isChallengeOrProposalSelected')
        ...
        <>
            <Box
                ...
                <Stack sx={disableCommunities ? { opacity: 0.4 } : {}}>
                    ...
                    <SideBarWrapper selectedItem={activeCommunity === 'FEDERAL'} lastIndex={4}>
                        <Divider sx={{ color: COLORS.greyIcon }} />
                        <Link href={'/'} key="4" style={{ textDecoration: 'none' }}>
                            <SideBarItem
                                key="4"
                    ...
                    <SideBarWrapper selectedItem={activeCommunity === 'STATE'} lastIndex={5}>
                        <Divider sx={{ color: COLORS.greyIcon }} />
