...
const TopProposals = ({ disabled, selectedId }: IchallengeView) => {
    ...
    const { setIsChallengeOrProposalSelected, setActiveCommunity } = useContext(CommunityContext)
    ...
    const { mutateAsync: unfollowPost } = useMutation(FollowersService.unfollowPost, {
        onMutate: newData => {
